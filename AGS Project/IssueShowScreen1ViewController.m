//
//  IssueShowScreen1ViewController.m
//  AGS Project
//
...
#import "IssueShowScreen1ViewController.h"
#import "sqlite3.h"
#import <MapKit/MapKit.h>
#import "MapViewAnnotation.h"

@interface IssueShowScreen1ViewController ()
@property (weak, nonatomic) IBOutlet MKMapView *mapView;

@end

@implementation IssueShowScreen1ViewController
@synthesize issueDescriptionLabel,issueTitleButton,IssueImageShow, databasePath,userProfilesDB1, issueTitleLabel;
...
- (void)viewDidLoad {
    ...
    {
        NSString *querySQL = [NSString stringWithFormat: @"SELECT ISSUETITLE, ISSUEDESCRIPTION, LOCATIONLONGITUDE, LOCATIONLATITUDE,IMAGEPATH,IMAGE, STATUS, DATE FROM REPORTEDISSUES WHERE ISSUENUMBER =\"%@\"", selectedIssueNumber];
        ...
        // This is changed, previously worked but check this why yellow error comes//MapViewAnnotation *annotation = [[MapViewAnnotation alloc] initWithTitle:issueTitleLabel.text AndCoordinate:coordinate];
...
{
   [self.navigationController pushViewController:[[self storyboard] instantiateViewControllerWithIdentifier:@"SelectedIssueReportScreen2"] animated:YES]; 
}
-(IBAction) imagePopUpShowView:(id)sender
{
